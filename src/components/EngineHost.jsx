        ...
        <main id="app">
            <aside id="panel">
                <div className="panel-head">
                    <div className="actions">
                        <button id="btnPeerCur" className="btn sm" aria-pressed="true" title="Mostrar cursor dos colaboradores no código">Cursor</button>
                        <button id="btnAutoFmt" className="btn sm" aria-pressed="false" title="Formatar automaticamente após parar de digitar">Auto ⌶</button>
                ...
                <div className="code-wrap">
                    ...
                    <div id="peerCursors" aria-hidden="true" />
            ...
            <section id="stage">
                <div id="canvas">
                    ...
                    <div id="peersBar" title="Pessoas conectadas nesta sessão" />
                    <div id="peersBar" title="Pessoas conectadas nesta sessão" />
                    <div id="toolbar">
